        ...
        <div className="w-full max-w-4xl px-6 lg:px-8 py-8 md:py-12 pb-24">
          ...
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="mb-10">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h1 className="text-4xl lg:text-5xl font-black text-slate-900 dark:text-white tracking-tighter uppercase italic pr-2">
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-400 to-[#0ea5e9] pr-2">MEUS</span><span className="ml-0.5">ROTEIROS</span>
                </h1>

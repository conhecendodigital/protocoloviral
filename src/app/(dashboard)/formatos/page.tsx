  ...
  return (
    <main className="flex-1 flex flex-col overflow-y-auto overflow-x-hidden relative z-10 custom-scrollbar">
      <div className="p-4 sm:p-6 lg:mx-auto max-w-7xl w-full space-y-8 pb-32">
        ...
        <section className="sticky top-0 z-30 pt-4 pb-6 bg-slate-50/90 dark:bg-[#060a12]/90 backdrop-blur-xl border-b border-slate-200/50 dark:border-white/5 mx-[-16px] sm:mx-[-24px] px-4 sm:px-6">

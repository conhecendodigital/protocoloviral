...
export async function POST(req: Request) {
  try {
    ...
    const systemPrompt = [
      ...
      '',
      '[TAMANHO, DENSIDADE E MICRO-BLOCOS]',
      'Profundidade NAO significa comprimento.',
      'Divida o roteiro em MULTIPLOS blocos curtos e focados para facilitar a leitura e edicao.',
      'NUNCA crie um bloco mestre gigante chamado [DESENVOLVIMENTO]. Em vez disso, quebre em blocos muito especificos: [EXPLICAÇÃO], [EXEMPLO], [PROVA SOCIAL], [AGRAVAMENTO], [DICA PRÁTICA], etc.',
      'NENHUM bloco pode ter mais de 3 ou 4 linhas de texto.',
      'Isso e essencial para a interface do nosso App.',
      ...
      '',
      '[NOME DO MICRO-BLOCO (ex: PROBLEMA, EXPLICACAO, PROVA, ETC)]',
      '',
      '(conteudo do micro-bloco curtos — uma ideia por linha)',
      '(Visual: instrucao isolada na propria linha)',
      '',
      '[NOME DE OUTRO MICRO-BLOCO]',
      '',
      '(conteudo do micro-bloco curtos — uma ideia por linha)',
      '',
      '[CTA]',

        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4 pt-4">
            <div className="p-4 rounded-xl bg-linear-to-br from-sky-50 to-violet-50 dark:from-sky-950/50 dark:to-violet-950/50 border border-sky-200/50 dark:border-sky-800/50">
              <p className="text-sm text-center text-slate-800 dark:text-white/90 dark:text-slate-800 dark:text-slate-300">
            ...
            <Button
              className="w-full bg-linear-to-r from-sky-500 to-violet-500 hover:from-sky-600 hover:to-violet-600 text-slate-900 dark:text-white font-semibold"
